      ...
      <form onSubmit={handleSubmit(onSubmit)} className="mt-10 grid gap-10 lg:grid-cols-[1fr,400px]">
          ...
          <Section title="Payment">
            <div className="flex items-center gap-3 rounded-xl border border-border bg-card p-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-muted-foreground">Payment gateway will be wired in the next step.</p>
              </div>
        ...
        <aside className="lg:sticky lg:top-24 lg:self-start">
          <div className="rounded-2xl border border-border bg-card p-5">
            ...
            >
              {formState.isSubmitting ? "Placing order..." : `Place order — ${formatINR(finalTotal)}`}
            </button>
